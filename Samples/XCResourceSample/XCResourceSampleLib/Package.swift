...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "xcresource",
            url: "https://github.com/nearfri/XCResource/releases/download/0.9.23/xcresource.artifactbundle.zip",
            checksum: "01db71c275477b83d3e8b3017d724bd1ec1e0361a0efd8b7fcb07605101ce593"
        ),
    ]
)
