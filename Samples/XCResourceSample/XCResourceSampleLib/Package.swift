...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "xcresource",
            url: "https://github.com/nearfri/XCResource/releases/download/0.9.19/xcresource.artifactbundle.zip",
            checksum: "bb157353fcecb602bea3c5275b2510c3570055a8054b293f58b6f33619609b06"
        ),
    ]
)
