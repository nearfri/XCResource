...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "xcresource",
            url: "https://github.com/nearfri/XCResource/releases/download/0.9.18/xcresource.artifactbundle.zip",
            checksum: "b067740c75e1c06771ff158cdea7cb81c12ab255f56d45a354ecab0c514f0916"
        ),
    ]
)
